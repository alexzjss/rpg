...
function buildAttack(id: string, label: string, options?: AbilityTemplateOptions): AbilityGraph {
  ...
  const nodes = [
    ...
    ...(o.conditionKind ? [n('condicao', 'aplicar_condicao', 'efeito', { classicKind: o.conditionKind, rounds: o.conditionRounds, value: o.conditionValue, chance: o.conditionChance })] : []),
  ];
...
const TEMPLATES: AbilityTemplate[] = [
  ...
  { id: 'ataque_aura_condicao', label: 'Ataque com aura e condicao', description: 'Ataque com custo de aura e condicao no alvo.', defaults: { testDice: '1d20', auraCost: 2, damageDice: '1d6', damageFlat: 0, element: 'fogo', conditionKind: 'queimadura', conditionRounds: 2, conditionValue: 2, conditionChance: 100 }, fields: [...attackFields, costField, ...conditionFields], build: o => buildAttack('ataque-aura-condicao', 'Ataque com condicao', o) },
